    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombreCompleto', models.CharField(default='', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opcionesValidacion', models.ManyToManyField(to='app_operador.opcionvalidacion')),
                ('tipoInformacion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_operador.tipoinformacion')),
