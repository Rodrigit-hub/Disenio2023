    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('llamada', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app_operador.llamada')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subOpcion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_operador.subopcionllamada')),
            ],
            options={
                'db_table': 'validacion',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('datoAValidar', models.CharField(default='', max_length=255)),
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_operador.cliente')),
        ...
        migrations.AddField(
            ...
            name='llamada',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='app_operador.llamada'),
        ),
        migrations.CreateModel(
            name='CambioEstado',
            fields=[
